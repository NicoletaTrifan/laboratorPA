...
//        for (int i = 0; i <= 2; i++) {
//            Hospital hospital1 = new Hospital("H" + i, capacity[i]);
//            list.add(hospital1);
//        }
//        var hospitals = list.toArray(new Hospital[0]);
//
//        ArrayList<Resident> residentList = new ArrayList<>(Arrays.asList(residents));
...
//        }
//        System.out.println();
//        Map<Resident, List<Hospital>> residentsPreferencesMap = new HashMap<>();
...
//        System.out.println();
//        Map<Hospital, List<Resident>> hospitalsPreferencesMap = new TreeMap<>();
//
...
//        System.out.println();
//
//        for (Map.Entry<Resident, List<Hospital>> entry : residentsPreferencesMap.entrySet()) {
//            System.out.println(entry.getKey() + ":" + "(" + entry.getValue() + ")");
//        }
//        System.out.println();
//        for (Map.Entry<Hospital, List<Resident>> entry : hospitalsPreferencesMap.entrySet()) {
//            System.out.println(entry.getKey() + ":" + "(" + entry.getValue() + ")");
//        }
...
//                .forEach(System.out::println);
        ...
        System.out.println(match.getResultedMatch());
