...
public class Hospital implements Comparable<Hospital> {
    private List<Resident> hospitalR;
    private String name;
    ...
    public Hospital(String name, int capacity) {
        ...
        hospitalR = new ArrayList<Resident>();
    }
    ...
    public List<Resident> getHospitalR() {
    ...
    public void setHospitalR(Resident... hospitalR) {
    ...
    public String toString() {
        ...
        sb.append(": ");
        sb.append("(");
        for (Resident resident : hospitalR) {
